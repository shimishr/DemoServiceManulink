...
module.exports = "<a routerLink = '/product'>+ Add Product</a>\n\n<h1>\n  Products\n</h1>\n\n<table>\n  <th>ID</th>\n  <th>Name</th>\n  <th>Username</th>\n  <tr *ngFor = \"let product of products\">\n    <td>{{product.id}}</td>\n    <td>{{product.name}}</td>\n    <td>{{product.username}}</td>\n  </tr>\n</table>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(http) {
        ...
        this.fetchData = function () {
            var _this = this;
            this.http.get("http://jsonplaceholder.typicode.com/users").subscribe(function (res) {
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(http) {
        ...
        this.addNewProduct = function (product) {
            ...
            this.http.post("http://jsonplaceholder.typicode.com/users/", this.productObj).subscribe(function (res) {
                console.log(res);
            });
        };
    }
...
module.exports = __webpack_require__(/*! C:\Users\shimishr\Code\Angular\src\main.ts */"./src/main.ts");
